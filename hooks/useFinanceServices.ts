import { useContext, createContext, ReactNode, createElement, useState, useCallback } from 'react'
...
export function useAssets() {
  ...
  return {
    ...
    convert: (from: AssetCode, to: AssetCode, amount: number) => asset.convertAsset(from, to, amount),
    format: (amount: number, code: AssetCode, hidden?: boolean) => asset.formatAsset(amount, code, hidden),
  }
}
